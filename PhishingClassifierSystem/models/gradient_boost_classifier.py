...
hyperparameters = {
    "n_estimators": np.arange(start=20, stop=250, step=10),
    "learning_rate": np.logspace(start=-1.5, stop=0.1, num=100, base=10),
    "max_depth": np.arange(start=3, stop=21, step=1),
    "ccp_alpha": np.logspace(start=-2, stop=-0.9, num=100, base=10),
    "min_samples_split": np.arange(start=3, stop=8, step=1)
}
...
with open("C:/Users/Shubhra/PycharmProjects/PhishingClassifierSystem/trained_models/gradient_boost_classifier.pkl",
          mode="wb") as file:
