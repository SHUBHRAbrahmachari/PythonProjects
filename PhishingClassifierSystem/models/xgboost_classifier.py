...
hyperparameters = {
    "n_estimators": np.arange(start=20, stop=251, step=10),
    "learning_rate": np.logspace(start=-1.5, stop=0.1, num=100, base=10),
    "reg_lambda": np.logspace(start=-1, stop=1.5, num=200, base=10),
...
with open("C:/Users/Shubhra/PycharmProjects/PhishingClassifierSystem/trained_models/xgboost_classifier.pkl",
          mode="wb") as file:
