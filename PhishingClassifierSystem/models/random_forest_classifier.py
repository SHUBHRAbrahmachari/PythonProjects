...
hyperparameters = {
    ...
    "max_depth": np.arange(start=2, stop=15, step=1),
    "ccp_alpha": np.logspace(start=-2, stop=-0.9, num=100)
}
...
with open("C:/Users/Shubhra/PycharmProjects/PhishingClassifierSystem/trained_models/random_forest_classifier.pkl",
          mode="wb") as file:
