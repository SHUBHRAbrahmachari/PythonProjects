...
hyperparameters = {
    ...
    "ccp_alpha": np.logspace(start=-1.5, stop=0.99, num=100)
}

model = RandomForestClassifier(random_state=42, n_jobs=-1, bootstrap=True, oob_score=False)
...
with open(
        "C:/Users/Shubhra/PycharmProjects/CustomerSegmentationSystem/classification/trained_models/random_forest_classifier.pkl",
        "wb") as file:
